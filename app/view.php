<?php 
	...
	Class View extends app {
		...
		static function lang()
		{
			...
			if(!isset($_SESSION['lang']) && file_exists(PATH . 'config/lang/' . LANG . '.php')) :

					$_SESSION['lang'] = LANG;
					return include PATH . 'config/lang/' . LANG . '.php';
				elseif(isset($_SESSION['lang']) && file_exists(PATH . 'config/lang/' . $_SESSION['lang'] . '.php')) :

					return include PATH . 'config/lang/' . $_SESSION['lang'] . '.php';
